...
router.get('/server/view-server-by-tag/:tagId/', middlewaresAuth.checkNotAuthenticated, serverControllers.retrieve_server_by_tag);
router.get('/server/view-server/:serverId/', middlewaresAuth.checkNotAuthenticated, serverControllers.retrieve_server_in_project);
