...
router.get("/project/retrieve-user-projects-servers/:sortField/:sortType/:offset/:limit/", middlewaresAuth.checkNotAuthenticated, projectControllers.retrieve_sorted_user_projects_with_servers);
